...
{\centering%
	...
	<<\MakeUppercase{\SPbPU}>>\\%
	\MakeUppercase{Института компьютерных наук и кибербезопасности}\\
...
{\noindent {\bfseries Руководитель практической подготовки от \SPbPUOfficialShort:}} {\expandafter \ulined \SupervisorFull, \SupervisorJob.} %Ф.И.О., должность, степень



%{\noindent \bfseries 
%	Консультант практической подготовки от \SPbPUOfficialShort:
